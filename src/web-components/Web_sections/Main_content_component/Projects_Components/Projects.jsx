...
function Projects_Components({
  ...
  return (
    <div className="projects_wrapper group p-3 rounded-md bg-slate-200 w-96 cursor-pointer">
      <figure className="relative">
        <img src={pro_img} alt={pro_title} />
      ...
      <div className="project_title_container flex justify-between mt-5 items-center pe-2">
        <div className="project_title w-4/5">
          <h2 className="text-3xl w-full text-blue-500 text-ellipsis text-nowrap overflow-hidden">
            {pro_title}
          </h2>
          <h3 className="text-xl mt-1 inline-block">{pro_detail}</h3>
        </div>
