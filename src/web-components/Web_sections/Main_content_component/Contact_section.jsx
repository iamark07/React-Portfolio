...
function Contact_section() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        const response = await fetch("https://formspree.io/f/mkgnwrog", {
          method: "POST",
          headers: {
  ...
  return (
    <section className="contact_section m-auto mt-32 p-5 md:p-8 lg:w-[80%] overflow-x-hidden">
      ...
      <div
        className="contact_container mt-10 bg-gradient-to-l from-[rgba(0,25,50,0.3)] to-[rgba(0,128,128,0.3)] rounded-md"
        data-aos="fade-left"
      >
        <div className="contact_header grid grid-cols-8 lg:gap-20 py-14 md:py-20 p-5 md:px-10 relative">
          <div className="contact_img_container hidden lg:block lg:col-span-3">
            <div className="contact_img absolute top-10 backdrop-blur-xl bg-opacity-50 border border-solid border-gray-500 bg-gray-700 rounded-lg">
              <img
                src="assets/img/profile_pic-2.png"
                alt=""
                className="lg:w-60 xl:w-72"
              />
            </div>
          </div>
          ...
          <div className="contact_details_wrapper flex flex-col gap-5 order-2 md:order-1">
            ...
            <div className="contact_details">
              ...
              <h3 className="text-white text-md">
                <a href="tel:7275781669">7275781669</a>
              </h3>
            </div>
            <Social_Media />
          </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-5">
              <div className="contact_input col-span-2 sm:col-span-1 flex flex-col">
                ...
                <input
                  ...
                  name="name"
                  placeholder="Name *"
                  className={`mt-2 bg-transparent p-2 border ${
                    errors.name ? "border-red-500" : "border-gray-200"
                  } outline-none text-white rounded-sm`}
                  value={formData.name}
                  onChange={(e) =>
              ...
              <div className="contact_input col-span-2 flex flex-col">
                ...
                <textarea
                  ...
                  } outline-none text-white rounded-sm h-32`}
              ...
              <div className="form_submit_btn col-span-2">
                <input
                  type="submit"
                  className=" w-32 md:w-40 text-md text-white py-3 px-5 border border-solid border-blue-500 transition-all duration-300 hover:bg-transparent bg-blue-500 rounded-sm cursor-pointer"
                  value={"Send Message"}
                />
              </div>
              {isSubmitted && (
