...
function About_reviews_box(props) {
  return (
    <div className='about_review_box w-44 bg-gray-700 backdrop-blur-xl bg-opacity-50 border border-solid border-gray-500 rounded-md flex justify-center items-center flex-col px-3 py-5'>
