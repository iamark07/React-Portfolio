  ...
  return (
    <section className="about_section py-32 md:py-44">
      <div className="about_container grid grid-cols-8 xl:grid-cols-7 gap-10 px-5 md:px-10">
        <div className="about_img xl:col-span-3 hidden xl:flex justify-center backdrop-blur-xl bg-opacity-50 border border-solid border-gray-500 bg-gray-700 rounded-lg">
